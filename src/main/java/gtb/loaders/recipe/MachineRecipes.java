...
public class MachineRecipes {
    ...
    ASSEMBLER_RECIPES.recipeBuilder()
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(MetaBlocks.BOILER_CASING.getItemVariant(BlockBoilerCasing.BoilerCasingType.POLYTETRAFLUOROETHYLENE_PIPE).getItem(), 4)
                .input(MetaBlocks.METAL_CASING.getItemVariant(BlockMetalCasing.MetalCasingType.PTFE_INERT_CASING).getItem(), 4)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(MetaBlocks.METAL_CASING.getItemVariant(BlockMetalCasing.MetalCasingType.TITANIUM_STABLE).getItem(),2)
        ...
        ModHandler.addShapedRecipe("water_tank", GTBMetaTileEntities.WATER_TANK.getStackForm(1),
                "WPW", "FSF", "WCW",
        ...
        ModHandler.addShapedRecipe("clarifier", GTBMetaTileEntities.CLARIFIER.getStackForm(1),
                "PCP", "UMU", "PCP",
        ...
        ModHandler.addShapedRecipe("digester", GTBMetaTileEntities.DIGESTER.getStackForm(1),
                "TTT", "PMP", "TTT",
                'M', MetaBlocks.MACHINE_CASING.getItemVariant(BlockMachineCasing.MachineCasingType.IV),
                'P', PISTON,
                'T', OreDictUnifier.get(plate, Titanium));

        ModHandler.addShapedRecipe("ffu", GTBMetaTileEntities.FROTH_FLOTATION_UNIT.getStackForm(1),
                "CPC", "PMP", "CPC",
                'M', MetaBlocks.MACHINE_CASING.getItemVariant(BlockMachineCasing.MachineCasingType.EV),
                'C', OreDictUnifier.get(circuit, MarkerMaterials.Tier.LV),
                'P', PUMP);
