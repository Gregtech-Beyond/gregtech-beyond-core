...
public class GTBBlockQuantumForceTransformerCasing extends VariantBlock<GTBBlockQuantumForceTransformerCasing.CasingType> {
    public GTBBlockQuantumForceTransformerCasing() {
        super(Material.IRON);
        this.setTranslationKey("gtb_quantum_force_transformer_casing");
