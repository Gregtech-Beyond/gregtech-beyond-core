...
public class GTBBlockComponentAssemblyLineCasing extends VariantBlock<GTBBlockComponentAssemblyLineCasing.CasingTier> {
    public GTBBlockComponentAssemblyLineCasing() {
        super(Material.IRON);
