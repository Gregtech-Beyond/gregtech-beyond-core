...
public class MetaTileEntityColdTower extends RecipeMapMultiblockController {

    public MetaTileEntityColdTower(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTBRecipeMaps.COLD_TOWER);
        initializeAbilities();
    }
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityColdTower(metaTileEntityId);
    }
}
