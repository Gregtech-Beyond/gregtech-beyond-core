...
public final class GTBMetaTileEntities {
    ...
    public static void init() {
        ...
        registerSimpleMetaTileEntity(
                ...
                CRYSTALLIZATION_RECIPES, Textures.ASSEMBLER_OVERLAY,
        ...
        registerSimpleMetaTileEntity(ROASTER, 4130, "roaster", ROASTER_RECIPES,
                GTBTextures.DEHYDRATOR_OVERLAY, true, GTBUtil::gtb, GTUtility.hvCappedTankSizeFunction);

        registerSimpleMetaTileEntity(DRYER, 4150, "dryer", DRYER_RECIPES,
                GTBTextures.DEHYDRATOR_OVERLAY, true, GTBUtil::gtb, GTUtility.hvCappedTankSizeFunction);
